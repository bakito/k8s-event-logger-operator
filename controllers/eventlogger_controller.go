...
// +kubebuilder:rbac:groups=eventlogger.bakito.ch,resources=eventloggers/status,verbs=get;update;patch

func (r *EventLoggerReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	_ = context.Background()
	_ = r.Log.WithValues("eventlogger", req.NamespacedName)
